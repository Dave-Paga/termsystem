...
/**
 * Data source for the DataEmployees view. This class should
...
export class DataEmployeesDataSource extends DataSource<DataEmployeesItem> {
   ...
   */
  connect(): Observable<DataEmployeesItem[]> {
   ...
   */
  private getPagedData(data: DataEmployeesItem[]): DataEmployeesItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: DataEmployeesItem[]): DataEmployeesItem[] {
