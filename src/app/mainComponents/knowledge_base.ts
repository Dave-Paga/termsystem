export var Knowledge = {
    ...
    "engine": [
        ...
        [9, "The noise is caused by an air/fuel mixture in the engine cylinder being ignited prematurely by the heat of compression as the piston is moving up on the compression stroke.", -1, "PROBLEM", 1000], //ask
        [10, "Are there rough idling sounds with inconsistent tachometer counts?", 11, 12],
        [11, "Sounds caused by damage or incorrectly installed spark plugs", -1, "PROBLEM", 1000], // ask
        ...
        [16, "Fuel line/piper problem", -1, "PROBLEM", 1000], //ask
        ...
        [25, "Something is wrong with the immobilizer system",-1, "PROBLEM", 1000] // ask
    ],
    
    "safety": [
        [0, "Is the drive belt too loose?", 1, 2],
        [1, "Check for insufficient battery charging, engine overheating, poor power steering, poor air conditioning, or excessive belt wear",-1, "PROBLEM", 1000], //ask
        ...
        [5, "This may indicate a dangerous carbon monoxide leak, and drive with the windows open and have the exhaust system checked immediately.",-1, "PROBLEM", 1000], //ask

        [6, "Is there excessive tire squealing when cornering?", 5, 7],
        [7, "Check if the steering and/or suspension elements need lubrication.",-1, "PROBLEM", 1000]
    ],
    ...
    "brake": [
        ...
        [2, "Have the break system inspected. Otherwise, check brake lines, as they could be damaged, there could be air in them, or they could also be damaged or leaking.",-1, "PROBLEM", 1000], //ask
    ...
    "transmission": [
        ...
        [2, "There may be a problem in the CVT",-1, "PROBLEM", 1000], //ask
        ...
        [10, "You cannot release the shift lever by depressing the brake pedal with the engine switch in the “ON” position. Check for repairs.",-1, "PROBLEM", 1000], //ask
    ...
    "chassis": [
        ...
        [1, "There is improper wheel alignment.",-1, "PROBLEm", 1000], //ask
