export var Knowledge = {
    ...
    "engine": [
        ...
        [9, "The noise is caused by an air/fuel mixture in the engine cylinder being ignited prematurely by the heat of compression as the piston is moving up on the compression stroke.", -1, "Engine cylinder problem", 11000], //Problem
        [10, "Are there rough idling sounds with inconsistent tachometer counts?", 11, 12],
        [11, "Sounds caused by damage or incorrectly installed spark plugs", -1, "Spark plug problem", 750], //Problem
        ...
        [16, "Fuel line/piper problem", -1, "Fuel Filter Replacement", 1600], //Problem
        [17, "Are there any fuel leaks?", 18, 5],
        [18, "Check A/C",-1, "A/C Repair", 3000], //Problem
        ...
        [25, "Something is wrong with the immobilizer system",-1, "Car immobilizer service", 5000] //Problem 
    ],
    
    "safety": [
        [0, "Is the drive belt too loose?", 1, 2],
        [1, "Check for insufficient battery charging, engine overheating, poor power steering, poor air conditioning, or excessive belt wear", -1, "Car Repair", 35000], //Problem (Preventive Maintenance Parts and service)
        ...
        [5, "This may indicate a dangerous carbon monoxide leak, and drive with the windows open and have the exhaust system checked immediately.",-1, "Catalytic Converter Replacement", 35000], //Problem

        [6, "Is there excessive tire squealing when cornering?", 5, 7],
        [7, "Check if the steering and/or suspension elements need lubrication.",-1, "Steering/Suspension problem", 5000] //  Problem
    ],
    ...
    "brake": [
        ...
        [2, "Have the brake system inspected. Otherwise, check brake lines, as they could be damaged, there could be air in them, or they could also be damaged or leaking.",-1, "Brake system replacement", 4700], //Problem
    ...
    "transmission": [
        ...
        [2, "There may be a problem in the CVT",-1, "Overhauling of CVT Transmission", 80000], //Problem
        ...
        [10, "You cannot release the shift lever by depressing the brake pedal with the engine switch in the “ON” position. Check for repairs.",-1, "Manual Transmission problem", 50000], //Problem
    ...
    "chassis": [
        ...
        [1, "There is improper wheel alignment.",-1, "Wheel alignment", 3000], //Problem
        [2, "Are there strange noises related to the suspension system?", 3,4],
        [3, "These are caused by worn out or damaged suspension bushings", -1, "Suspension problem", 30000], //Problem
